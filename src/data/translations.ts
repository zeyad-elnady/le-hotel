export const translations = {
  ...
  header: {
    explore: { en: "EXPLORE MORE", ar: "استكشف المزيد", fr: "EXPLORER PLUS" },
    booking: { en: "BOOK NOW", ar: "احجز الآن", fr: "RÉSERVER" },
    help: { en: "Need Help? Call Us", ar: "هل تحتاج مساعدة؟ اتصل بنا", fr: "Besoin d'aide ? Appelez-nous" },
  },
  footer: {
    description: {
      en: "Experience absolute luxury and tranquil serenity at le hotel. A sanctuary of refinement and elegance in every detail.",
      ar: "عش تجربة الفخامة المطلقة والهدوء التام في فندق لو هوتيل. ملاذ مفعم بالرقي والأناقة في كل التفاصيل.",
      fr: "Vivez l'expérience du luxe absolu et de la sérénité au le hotel. Un sanctuaire de raffinement et d'élégance dans les moindres détails.",
    },
    quickLinks: { en: "Quick Links", ar: "روابط سريعة", fr: "Liens Rapides" },
    newsletter: { en: "Newsletter", ar: "النشرة الإخبارية", fr: "Bulletin" },
    subscribe: { en: "Subscribe Now", ar: "اشترك الآن", fr: "S'abonner" },
    placeholder: { en: "Enter your email...", ar: "أدخل بريدك الإلكتروني...", fr: "Votre adresse e-mail..." },
    copyright: {
      en: "© 2026 le hotel. All rights reserved.",
      ar: "© 2026 فندق لو هوتيل. جميع الحقوق محفوظة.",
      fr: "© 2026 le hotel. Tous droits réservés.",
    },
  },
  checkout: {
    title: { en: "Check Availability", ar: "التحقق من التوفر", fr: "Vérifier la Disponibilité" },
    checkIn: { en: "Check In", ar: "تاريخ الوصول", fr: "Arrivée" },
    checkOut: { en: "Check Out", ar: "تاريخ المغادرة", fr: "Départ" },
    guests: { en: "Guests", ar: "الضيوف", fr: "Invités" },
    search: { en: "Book Now", ar: "احجز الآن", fr: "Réserver" },
    roomsNum: { en: "Rooms", ar: "الغرف", fr: "Chambres" },
  },
  home: {
    hero: {
    ...
    about: {
      subtitle: { en: "Sleep in Style and Serenity", ar: "نوم مريح في أجواء من الأناقة والسكينة", fr: "Dormez avec Style et Sérénité" },
      title: { en: "Luxury, Location & Love: Why Stay With Us", ar: "الفخامة والموقع المثالي: أسباب تدفعك للإقامة معنا", fr: "Luxe, Emplacement & Passion : Pourquoi Nous Choisir" },
      desc: {
        en: "At le hotel, we redefine the standard of luxury hospitality. Every suite is meticulously designed, combining modern intelligence with timeless design aesthetics.",
        ar: "في فندق لو هوتيل، نعيد تعريف معايير الضيافة الفاخرة. تم تصميم كل جناح بدقة فائقة، يجمع بين التكنولوجيا الحديثة وجماليات التصميم الخالدة.",
        fr: "Au le hotel, nous redéfinissons les standards de l'hôtellerie de luxe. Chaque suite est méticuleusement conçue, alliant intelligence moderne et esthétique intemporelle.",
      },
      bullets: [
        { en: "Unparalleled Service", ar: "خدمة لا تضاهى على مدار الساعة", fr: "Service Inégalé" },
        { en: "Gourmet Michelin Dining", ar: "أطعمة فاخرة حائزة على نجمة ميشلان", fr: "Restauration Gastronomique" },
        { en: "Wellness Spa & Hammam", ar: "منتجع صحي متكامل وحمام استرخاء", fr: "Spa et Bien-être" },
        { en: "Eco-Friendly Operations", ar: "ممارسات بيئية مستدامة بالكامل", fr: "Opérations Écoresponsables" },
      ],
    },
    discover: {
      subtitle: { en: "OUR LUXURIOUS ACCOMMODATIONS", ar: "أماكن الإقامة الفاخرة لدينا", fr: "NOS HÉBERGEMENTS LUXUEUX" },
      title: { en: "Designed For Ultimate Comfort", ar: "مصممة لتوفير أقصى درجات الراحة", fr: "Conçue pour un Confort Ultime" },
    },
    experience: {
    ...
    advance: {
      subtitle: { en: "CRAFTING MEMORABLE EXPERIENCES", ar: "صنع ذكريات لا تُنسى في ملاذنا", fr: "CRÉER DES SOUVENIRS MÉMORABLES" },
      title: {
        en: "We're dedicated to providing you an unforgettable luxury retreat.",
        ar: "نحن ملتزمون بتقديم ملاذ فاخر وتجربة استثنائية لا تُنسى لك.",
        fr: "Nous nous engageons à vous offrir une retraite de luxe inoubliable.",
      },
    },
    features: {
    ...
    brands: {
      subtitle: { en: "OUR PRESTIGE PARTNERS", ar: "شركاء الفخامة والريادة لدينا", fr: "NOS PARTENAIRES DE PRESTIGE" },
      title: { en: "We Collaborate With Global Luxury Brands", ar: "نحن نتعاون ونشترك مع أفضل العلامات التجارية الفاخرة عالمياً", fr: "Nous Collaborons Avec des Marques de Luxe Mondiales" },
    },
  },
  rooms: {
    title: { en: "Our Rooms & Suites", ar: "غرفنا وأجنحتنا الفاخرة", fr: "Nos Chambres & Suites" },
    subtitle: { en: "Experience Elegance & Refinement", ar: "عش تجربة الأناقة والرقي المتكامل", fr: "Découvrez l'Élégance & le Raffinement" },
    filterAll: { en: "All Accommodations", ar: "جميع الغرف والأجنحة", fr: "Tous les Hébergements" },
    filterDeluxe: { en: "Deluxe Rooms", ar: "غرف ديلوكس", fr: "Chambres Deluxe" },
    filterSuites: { en: "Luxury Suites", ar: "أجنحة فاخرة", fr: "Suites de Luxe" },
    perNight: { en: "/ Night", ar: "/ ليلة", fr: "/ Nuit" },
    details: { en: "View Details", ar: "عرض التفاصيل", fr: "Voir les Détails" },
    book: { en: "Book Room", ar: "احجز الغرفة", fr: "Réserver la Chambre" },
    beds: { en: "Beds", ar: "سرير", fr: "Lits" },
    size: { en: "Size", ar: "المساحة", fr: "Superficie" },
    items: [
      {
        id: "1",
        type: "suite",
        title: { en: "Royal Presidential Suite", ar: "الجناح الرئاسي الملكي", fr: "Suite Présidentielle Royale" },
        price: "1,200",
      ...
      },
      {
        id: "2",
        type: "suite",
        title: { en: "Executive Garden Suite", ar: "جناح الحديقة التنفيذي", fr: "Suite Executive avec Jardin" },
        price: "850",
        beds: { en: "1 King Bed", ar: "1 سرير كينج كبير", fr: "1 Lit King-Size" },
      ...
      },
      {
        id: "3",
        type: "deluxe",
        title: { en: "Signature Deluxe Room", ar: "غرفة ديلوكس التوقيعية", fr: "Chambre Signature Deluxe" },
        price: "550",
  ...
  reviews: {
    title: { en: "Guest Testimonials", ar: "تقييمات وآراء ضيوفنا", fr: "Avis de Nos Clients" },
    subtitle: { en: "Stories of Unforgettable Memories", ar: "قصص وذكريات لا تُنسى من ضيوفنا الكرام", fr: "Souvenirs de Moments Inoubliables" },
    averageRating: { en: "Average Rating", ar: "متوسط التقييم", fr: "Note Moyenne" },
    basedOn: { en: "based on 240+ reviews", ar: "بناءً على أكثر من 240 تقييماً", fr: "sur plus de 240 avis" },
    writeTitle: { en: "Share Your Experience", ar: "شاركنا تجربتك الخاصة", fr: "Partagez Votre Expérience" },
    writeSubtitle: { en: "We would love to hear your feedback", ar: "يسعدنا جداً سماع رأيك وتقييمك لخدماتنا", fr: "Nous serions ravis de recevoir vos commentaires" },
    formName: { en: "Your Name", ar: "الاسم الكامل", fr: "Votre Nom" },
    formEmail: { en: "Your Email", ar: "البريد الإلكتروني", fr: "Votre E-mail" },
    formRating: { en: "Rating", ar: "التقييم", fr: "Note" },
    formComment: { en: "Your Review", ar: "اكتب تقييمك هنا...", fr: "Votre Commentaire" },
    formSubmit: { en: "Submit Review", ar: "إرسال التقييم", fr: "Envoyer l'Avis" },
    formSuccess: {
      en: "Thank you! Your review has been submitted successfully and is awaiting approval.",
      ar: "شكرًا لك! تم تقديم تقييمك بنجاح وهو قيد المراجعة حاليًا.",
      fr: "Merci ! Votre avis a été soumis avec succès et est en attente d'approbation.",
    },
    items: [
      {
        name: "Alexandra Sterling",
        role: { en: "Luxury Travel Editor", ar: "محررة أسفار فاخرة", fr: "Rédactrice Voyage de Luxe" },
        text: {
          en: "An absolute dream come true. The level of personalization is outstanding. The staff knew my name and preferences before I even requested them. The Royal Suite is pure paradise.",
          ar: "حلم حقيقي أصبح واقعاً! مستوى التخصيص والاهتمام مذهل للغاية. طاقم العمل كان يعلم اسمي وتفضيلاتي الشخصية قبل أن أطلبها. الجناح الرئاسي هو جنة حقيقية على الأرض.",
          fr: "Un rêve absolu devenu réalité. Le niveau de personnalisation est exceptionnel. Le personnel connaissait mon nom et mes préférences avant même que je ne les demande. La Suite Royale est un paradis.",
        },
        rating: 5,
        date: "May 2026",
      },
  ...
  jobs: {
    title: { en: "Careers at le hotel", ar: "فرص العمل في لو هوتيل", fr: "Carrières au le hotel" },
    subtitle: { en: "Join Our Team of Excellence", ar: "انضم إلى فريق عملنا المتميز", fr: "Rejoignez Notre Équipe d'Excellence" },
    intro: {
      en: "At le hotel, our people are our greatest strength. We seek passionate, dedicated individuals who aspire to define the future of ultra-luxury hospitality.",
      ar: "في فندق لو هوتيل، موظفونا هم مصدر قوتنا الأكبر. نحن نبحث عن أشخاص شغوفين ومتميزين يتطلعون إلى تشكيل مستقبل الضيافة فائقة الفخامة.",
      fr: "Au le hotel, nos collaborateurs sont notre plus grande force. Nous recherchons des personnes passionnées et dévouées pour définir l'avenir de l'hôtellerie de luxe.",
    },
    location: { en: "Location", ar: "الموقع", fr: "Lieu" },
    type: { en: "Type", ar: "الدوام", fr: "Type" },
    apply: { en: "Apply for Position", ar: "التقديم للوظيفة", fr: "Postuler" },
    modalTitle: { en: "Job Application", ar: "طلب التقديم للوظيفة", fr: "Candidature" },
    fullName: { en: "Full Name", ar: "الاسم الكامل", fr: "Nom Complet" },
    email: { en: "Email Address", ar: "البريد الإلكتروني", fr: "Adresse E-mail" },
    coverLetter: { en: "Cover Letter", ar: "رسالة التغطية / تقديم ذاتي", fr: "Lettre de Motivation" },
    submitApp: { en: "Submit Application", ar: "إرسال الطلب", fr: "Envoyer la Candidature" },
    appSuccess: {
      en: "Thank you for applying! Our human resource team will review your profile and reach out shortly.",
      ar: "شكرًا لتقديمك! سيقوم فريق الموارد البشرية لدينا بمراجعة ملفك الشخصي والتواصل معك قريبًا.",
      fr: "Merci pour votre candidature ! Notre équipe des ressources humaines l'examinera et vous contactera sous peu.",
    },
    openings: [
      {
        id: "1",
        ...
        desc: {
          ...
          ar: "بصفتك نقطة الاتصال الأولى، ستتولى تقديم تجربة استقبال وترحيب شخصية خالية من الأخطاء وتضمن شعور الضيوف بالترحيب في عالم من الرقي المطلق.",
          fr: "En tant que premier point de contact, vous créerez des expériences d'accueil personnalisées et veillerez à ce que les clients se sentent accueillis dans un monde raffiné.",
        },
      },
      {
        id: "2",
        ...
        desc: {
          ...
          ar: "اعمل بالتعاون في مطبخنا الحائز على نجمة ميشلان. أشرف على إعداد المأدبة الفاخرة وابتكر أطباقاً حسية حديثة باستخدام مكونات محلية ممتازة.",
          fr: "Collaborez dans notre cuisine étoilée. Supervisez la préparation de banquets sur mesure et perfectionnez des plats sensoriels en utilisant des ingrédients locaux.",
        },
      },
      {
        id: "3",
        ...
        desc: {
          ...
          ar: "تقديم علاجات تدليك فاخرة ومخصصة بالكامل، وطقوس العناية بالبشرة، وجلسات العلاج العطري المصممة لإراحة الجسد وتجديد الروح.",
          fr: "Proposez des thérapies de massage sur mesure, des soins de la peau et des parcours d'aromathérapie conçus pour détendre le corps et régénérer l'esprit.",
        },
      },
    ],
  },
  ...
  contact: {
    title: { en: "Begin Your Story With Us", ar: "ابدأ قصتك وتجربتك الفريدة معنا", fr: "Commencez Votre Histoire Avec Nous" },
    subtitle: { en: "Reach Out to le hotel", ar: "تواصل مع فندق لو هوتيل", fr: "Contacter le hotel" },
    formTitle: { en: "Send A Message", ar: "أرسل رسالة لنا", fr: "Envoyer un Message" },
    formName: { en: "Your Name", ar: "الاسم الكامل", fr: "Votre Nom" },
    formEmail: { en: "Email Address", ar: "البريد الإلكتروني", fr: "Adresse E-mail" },
    formSubject: { en: "Subject", ar: "الموضوع", fr: "Sujet" },
    formMessage: { en: "Your Message", ar: "اكتب رسالتك هنا...", fr: "Votre Message" },
    formSubmit: { en: "Send Message Now", ar: "أرسل الرسالة الآن", fr: "Envoyer le Message" },
    formSuccess: {
      en: "Thank you! Your message has been sent successfully. Our concierge desk will respond shortly.",
      ar: "شكرًا لك! تم إرسال رسالتك بنجاح. سيقوم مكتب الاستعلامات والكونسيرج بالرد عليك قريبًا.",
      fr: "Merci ! Votre message a été envoyé avec succès. Notre service de conciergerie vous répondra sous peu.",
    },
